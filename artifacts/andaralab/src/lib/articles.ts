...
export const articles: Article[] = [
  ...
  },
  {
    ...
    category: "Market Pulse", categoryHref: "/blog/market-pulse",
    body: [
      "The Indonesian Rupiah (IDR) has strengthened from 16,200 to 15,890 per USD over the past four weeks — an appreciation of approximately 2%. For a currency that spent much of 2024 under pressure, this is a meaningful shift. What is driving it?",
