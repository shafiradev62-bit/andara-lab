        ...
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="max-w-[720px]">
            ...
            <p className="text-[15px] text-gray-500 leading-relaxed">
              AndaraLab bridges the gap between complex global shifts and local
              investment opportunities by transforming raw economic data into
              high-precision strategic intelligence. As the dedicated research
              arm of PT. Andara Investasi Cerdas, our "laboratory" approach
              combines rigorous econometric modeling with deep institutional
              expertise to ensure every insight is both scientifically grounded
